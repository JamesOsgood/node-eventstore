...
function Mongo(options) {
  ...
  var defaults = {
    ...
    url : "mongodb+srv://eventstore:c3xjer1SQJ7QpEe5@rpi-sensor-data-ifxxs.mongodb.net/eventstore?retryWrites=true"
  };
...
_.extend(Mongo.prototype, {
  ...
  connect: function (callback) {
    ...
    function initDb() {
      self.client.on('serverClosed', function() {
